...
variable "secondary_ranges" {
  ...
  default     = {subnet-us-east-4-01-01=[{range_name="master-subnet",ip_cidr_range="10.140.16.0/28"},{range_name="pods-subnet",ip_cidr_range="10.141.0.0/20"},{range_name="svc-subnet",ip_cidr_range="10.122.0.0/20"}]}
}
